                    ...
                    if len(tracked_dets)>0:
                        ...
                        if opt.show_track:
                            ...
                            for t, track in enumerate(tracks):               
                                ...
                                [cv2.line(im0, (int(getattr(track, det_position)[i][0]),
                                                int(getattr(track, det_position)[i][1])), 
                                                (int(getattr(track, det_position)[i+1][0]),
                                                int(getattr(track, det_position)[i+1][1])),
